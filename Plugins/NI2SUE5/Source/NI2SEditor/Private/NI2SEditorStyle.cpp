...
TSharedPtr<FSlateStyleSet> FNI2SEditorStyle::StyleInstance = NULL;
...
TSharedRef<FSlateStyleSet> FNI2SEditorStyle::Create()
{
	...
	Style->SetContentRoot(IPluginManager::Get().FindPlugin("NI2SUE5")->GetBaseDir() / TEXT("Resources"));

	Style->Set("NI2SEditor.OpenPluginWindow", new IMAGE_BRUSH_SVG(TEXT("PlaceholderButtonIcon"), Icon20x20));
	Style->Set("NI2SEditor.PluginAction", new IMAGE_BRUSH_SVG(TEXT("PlaceholderButtonIcon"), Icon20x20));
