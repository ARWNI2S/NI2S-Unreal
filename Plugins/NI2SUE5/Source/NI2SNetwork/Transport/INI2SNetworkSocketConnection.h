...
public:
	...
	virtual bool WaitForConnection(double InTimeout, TFunction<bool(TSharedRef<INI2SNetworkSocketConnection>)> InDelegate) = 0;
...
protected:
	...
	INI2SNetworkSocketConnection() {}
	virtual ~INI2SNetworkSocketConnection() {}
};
