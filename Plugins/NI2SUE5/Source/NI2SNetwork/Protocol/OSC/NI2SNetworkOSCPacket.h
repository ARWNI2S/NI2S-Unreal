 ...
 */
class NI2SNETWORK_API FNI2SNetworkOSCPacket
{
public:

	virtual ~FNI2SNetworkOSCPacket() {}
	...
	static TSharedPtr<FNI2SNetworkOSCPacket> CreateFromBuffer(const void* Data, int32 DataLength);
};

class FNI2SNetworkOSCNullPacket : public FNI2SNetworkOSCPacket
{
public:
