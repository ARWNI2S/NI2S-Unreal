...
*
*/
class NI2SNETWORK_API FNI2SNetworkConnection : public INI2SNetworkSocketConnection, public TSharedFromThis<FNI2SNetworkConnection>
{
public:

	FNI2SNetworkConnection();
	~FNI2SNetworkConnection();
	...
	virtual bool WaitForConnection(double InTimeout, TFunction<bool(TSharedRef<INI2SNetworkSocketConnection>)> InDelegate) override;
