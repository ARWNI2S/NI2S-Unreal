...
/**
 * Declares the interface for a NI2SNetwork packet
 */
class NI2SNETWORK_API INI2SNetworkPacket
{
public:

	virtual ~INI2SNetworkPacket() {}

	virtual FNI2SNetworkPacketType GetProtocolID() const = 0;
