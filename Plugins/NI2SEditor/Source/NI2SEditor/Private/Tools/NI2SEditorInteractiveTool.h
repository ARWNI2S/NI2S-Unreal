...
#include "NI2SEditorInteractiveTool.generated.h"


/**
 * Builder for UNI2SEditorInteractiveTool
 */
UCLASS()
class NI2SEDITOR_API UNI2SEditorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UNI2SEditorInteractiveTool
 */
UCLASS(Transient)
class NI2SEDITOR_API UNI2SEditorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UNI2SEditorInteractiveToolProperties();
...
/**
 * UNI2SEditorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class NI2SEDITOR_API UNI2SEditorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UNI2SEditorInteractiveToolProperties> Properties;
