...
#include "NI2SEditorInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UNI2SEditorInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UNI2SEditorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UNI2SEditorInteractiveTool* NewTool = NewObject<UNI2SEditorInteractiveTool>(SceneState.ToolManager);
...
UNI2SEditorInteractiveToolProperties::UNI2SEditorInteractiveToolProperties()
{
...
void UNI2SEditorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UNI2SEditorInteractiveTool::Setup()
{
	...
	Properties = NewObject<UNI2SEditorInteractiveToolProperties>(this, "Measurement");
...
void UNI2SEditorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UNI2SEditorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UNI2SEditorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UNI2SEditorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UNI2SEditorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UNI2SEditorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UNI2SEditorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UNI2SEditorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UNI2SEditorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
